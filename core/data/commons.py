...
# todo MNIST is not that useful, we can remove it
...
def read_cup(
    ...
    if use_internal_test_set and not (os.path.exists(internal_test_set_path) and os.path.exists(original_train_set_path)):
