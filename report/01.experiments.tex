...
\todo{Add MONK without regularization!}
...
\begin{table}[htb]
    ...
    \begin{tabular}{|c|c|c|c|c|c|c|c|c|}
        ...
        $32-16$ & \texttt{tanh} & $0.005$ & $0.8$ & $6e-6$ & linear $0.1$ & $1.2601$ & $1.4090$ \\ \hline
    \end{tabular}
    }
